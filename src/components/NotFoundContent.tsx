    ...
    >
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-20">
        <div className="text-center max-w-md">
          ...
          <p
            className="font-oswald font-bold text-7xl mb-2"
            style={{ color: "var(--teal)" }}
          >
            404
          </p>
          <h1
            className="font-oswald font-bold text-2xl mb-3"
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              ...
              aria-label="Позвонить по телефону 8 918 968-28-82"
            >
          ...
          <div className="mt-10 grid grid-cols-2 gap-3 text-left">
            <Link
              ...
              className="bg-white rounded-xl p-4 shadow-sm flex items-center gap-3 hover-lift"
              aria-label="Перейти к услуге химчистка диванов"
            >
              <Icon
                name="Sofa"
                size={20}
            ...
            <Link
              ...
              className="bg-white rounded-xl p-4 shadow-sm flex items-center gap-3 hover-lift"
              aria-label="Перейти к услуге химчистка ковров"
            >
              <Icon
                name="LayoutGrid"
                size={20}
            ...
            <Link
              ...
              className="bg-white rounded-xl p-4 shadow-sm flex items-center gap-3 hover-lift"
              aria-label="Перейти к услуге химчистка матрасов"
            >
              <Icon
                name="Bed"
                size={20}
            ...
            <Link
              to="/nashi-raboty"
              className="bg-white rounded-xl p-4 shadow-sm flex items-center gap-3 hover-lift"
              aria-label="Перейти к странице с нашими работами"
            >
              <Icon
                name="Images"
                size={20}
      ...
      <footer className="border-t bg-white">
        <div
          className="max-w-5xl mx-auto px-4 sm:px-6 py-6 text-center text-sm"
          style={{ color: "var(--gray)" }}
        >
