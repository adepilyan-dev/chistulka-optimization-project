...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-3 left-3 right-3 sm:left-auto sm:right-4 z-[100] sm:max-w-xs animate-fade-up">
      <div
        className="bg-white rounded-xl shadow-xl border p-3.5"
        style={{ borderColor: "rgba(12,184,160,0.2)" }}
      >
        ...
        <div className="flex gap-2">
          <button
            type="button"
            onClick={() => decide("no")}
            className="flex-1 px-3 py-1.5 text-xs font-semibold rounded-full transition-all hover:bg-gray-50"
          ...
          <button
            type="button"
            onClick={() => decide("yes")}
            className="flex-1 btn-primary px-3 py-1.5 text-xs font-semibold"
          >
            Принять
          </button>
        </div>
