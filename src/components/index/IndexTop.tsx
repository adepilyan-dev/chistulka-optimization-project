...
// ============================================================
// МИКРОРАЗМЕТКА ДЛЯ ОРГАНИЗАЦИИ (глобальная)
// ============================================================
...
const organizationLd = {
  ...
  sameAs: [
    ...
    "https://max.ru/u/f9LHodD0cOIhDoRH_6LXfcSUOHBuL1Ox9Kjst5F3mN4736vAC4pXtz-GKzc",
  ],
  geo: {
    "@type": "GeoCoordinates",
    latitude: 45.0355,
...
// ============================================================
// КОМПОНЕНТ НАВБАР (с исправленной доступностью)
// ============================================================
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-3">
          <a
            ...
            style={{ color: "var(--teal)" }}
            aria-label="Позвонить: 8 918 968-28-82"
          >
...
// ============================================================
// КОМПОНЕНТ HERO (с микроразметкой)
// ============================================================
...
export function Hero() {
  const heroLd = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: "Химчистка мебели в Краснодаре с выездом | Аренда Чистоты",
    description:
  ...
  return (
    ...
    >
      <Helmet>
        <script type="application/ld+json">{JSON.stringify(heroLd)}</script>
      </Helmet>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 w-full pt-24 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-7">
            ...
            <p
              className="speakable text-lg animate-fade-up stagger-3"
              style={{ color: "var(--gray)", maxWidth: 480 }}
            >
              Профессиональная химчистка диванов, кресел, матрасов и ковров в
              Краснодаре. Выезд на дом, безопасные средства, сушка за 2–4 часа.
            </p>
...
// ============================================================
// КОМПОНЕНТ MARQUEE (без изменений, но с aria-hidden)
// ============================================================
...
// ============================================================
// КОМПОНЕНТ SERVICES (с исправленными изображениями)
// ============================================================
...
// ============================================================
// КОМПОНЕНТ CALCULATOR (с улучшенной доступностью)
// ============================================================
...
// ============================================================
// КОМПОНЕНТ ДЛЯ ГЛОБАЛЬНОЙ МИКРОРАЗМЕТКИ (использовать в App.tsx)
// ============================================================
