...
// 🏷️ Исправлен URL в микроразметке
const SEO_LD = [
  {
    ...
    url: "https://arenda-chistoty.ru/", // ✅ ИСПРАВЛЕНО
    priceRange: "₽₽",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            url: "https://arenda-chistoty.ru/uslugi/himchistka-divanov",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            url: "https://arenda-chistoty.ru/uslugi/himchistka-kresel",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            url: "https://arenda-chistoty.ru/uslugi/himchistka-matrasov",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            url: "https://arenda-chistoty.ru/uslugi/himchistka-kovrov",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            url: "https://arenda-chistoty.ru/uslugi/himchistka-avtosalona",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            url: "https://arenda-chistoty.ru/uslugi/himchistka-stulev",
          },
        },
      ],
    },
