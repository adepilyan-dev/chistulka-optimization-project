...
const SECTIONS = [
  {
    ...
    text: "Настоящая Политика конфиденциальности регулирует порядок обработки и защиты персональных данных пользователей сайта arenda-chistoty.online (далее — «Сайт»), оказывающего услуги химчистки мебели в Краснодаре. Используя Сайт, вы соглашаетесь с условиями данной Политики.",
  },
  {
